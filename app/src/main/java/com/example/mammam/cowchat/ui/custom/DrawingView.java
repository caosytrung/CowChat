...
import com.example.mammam.cowchat.models.BrushStrock;
...
/**
 * Created by caotr on 05/10/2016.
 */

public class DrawingView extends View implements IConstand{
    ...
    private void initPain(){
        SharedPreferences drawShare = context.getSharedPreferences(DRAW,Context.MODE_PRIVATE);

        int defaultColor = Color.parseColor(drawShare.getString(KEY_DEFAULE_COLOR_PEN,"")) ;
        int defaultWidth = drawShare.getInt(KEY_DEFAULT_WIDTH_PEN_DRAW,0);
        mPaint = new Paint();
